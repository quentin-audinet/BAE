#!/usr/bin/python
from bffl import Node, Graph

# Declare files
GRAPH =              "behaviour.bffl"
...
OUTPUT_MAIN_EBPF =  "bae-ebpf/src/main.rs"
OUTPUT_MAIN =       "bae/src/main.rs"
OUTPUT_CONDITIONS = "bae-ebpf/src/conditions.rs"
OUTPUT_COMMON =     "bae-common/src/lib.rs"
